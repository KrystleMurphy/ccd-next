...
const TextSection = ({ duration, handsOnTime, samples, description }) => (
  <div className="flex flex-col justify-center w-full lg:w-1/2 pl-4  p-4 ">
...
const Section = ({ steps, textSectionProps }) => (
  <div className="divide-y divide-gray-200 overflow-hidden rounded-lg mx-auto max-w-7xl sm:px-6 lg:px-6 ">
    <div className="rounded group relative bg-white p-6 flex flex-col lg:flex-row w-full">
      <div className="flex flex-col lg:flex-row items-center justify-between w-full lg:w-1/2 bg-white rounded p-4">
        <div className="flex flex-col lg:flex-row gap-12 w-full text-ccDarkBlue border border-ccLightBlue/5 rounded-md bg-ccLightBlue/5">
...
export default function Flow() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-12 sm:px-6 md:py-16 lg:px-8">
