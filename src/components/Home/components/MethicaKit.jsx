// components/MethicaKit.jsx
import { ArrowTrendingUpIcon, BeakerIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
...
const supportLinks = [
  {
    name: '97%',
    href: '#',
    description: 'Of cases detected using CC Diagnostics superior technology',
    icon: ArrowTrendingUpIcon,
  },
  {
    name: '100%',
    href: '#',
    description: 'Cervical cancer detected of 3421 samples',
    icon: ShieldCheckIcon,
  },
  {
    name: '6X',
    href: '#',
    description: 'Times less hands on time of lab-technicians.',
    icon: BeakerIcon,
  },
];
    ...
    <div id="methicaKit" className="bg-ccAliceBlue">
      ...
      <div className="relative bg-white pb-32">
        <div className="absolute inset-0 opacity-50">
          <Image
            src="/images/Methica_CC_prototype_2.jpg" // Update path to point to the public folder
            alt="Methica Kit"
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight text-ccDarkBlue md:text-5xl lg:text-6xl">
            Methica CC Kit
          </h1>
