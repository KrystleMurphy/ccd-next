...
import SearchBar from "../../../components/SearchDocs/SearchBar";
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-2">
            <Image
              ...
              src="/images/logo.png" // Update path to use the public folder
          ...
          <div className="mt-16 grid grid-cols-4 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="mt-10 md:mt-0 px-6">
              ...
              <Airtable tableName="Policies" view="Grid view" renderItem={Policy} />
            </div>
            <div className="mt-10 md:mt-0 px-6 col-span-2">
              <h3 className="text-sm font-semibold leading-6 text-ccDarkBlue">
                Contact
              </h3>
              <Airtable tableName="Contact" view="Grid view" renderItem={ContactInfo} />
            </div>
          </div>
        </div>
