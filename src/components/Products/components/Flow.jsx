...
const Step = ({ icon: Icon, imageSrc, label }) => (
  <div className="flex flex-col items-center justify-center">
    ...
    {imageSrc && (
      <Image
        src={imageSrc}
        alt={label} // Use a descriptive alt attribute for better accessibility
        width={48}
        height={48}
        ...
        <div className='py-24 sm:py-24'>
          ...
          <Section
            steps={[
              ...
              { imageSrc: '/images/cc_arrowLong.png', label: 'Nucleic acid isolation' },
          ...
          <Section
            steps={[
              ...
              { imageSrc: '/images/cc_arrowLong.png', label: 'Bisulfite treatment' },
          ...
          <Section
            steps={[
              ...
              { imageSrc: '/images/cc_arrowLong.png', label: 'Methica CC kit' },
